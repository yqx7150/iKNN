...
parser.add_argument("--ckpt_60", type=str, default=f'./exps/{channel_ONE}to{channel_TWO}/checkpoint/{modelNum}.pth',
                    help="Checkpoint path.")
parser.add_argument("--ckpt_79", type=str, default=f'./exps/{channel_ONE}to{channel_TWO}/checkpoint/{modelNum}.pth',
                    help="Checkpoint path.")
...
def main(args):
    ...
    net_79 = InvISPNet(channel_in=channel_in, channel_out=channel_in, block_num=8)
    device = torch.device("cuda:0")
    net_79.to(device)
    net_79.eval()
    ...
    if os.path.isfile(args.ckpt_79):
        net_79.load_state_dict(torch.load(args.ckpt_79), strict=False)
        print("[INFO] Loaded checkpoint_79: {}".format(args.ckpt_79))
    ...
    mri_dataset = mriDataset_real_imag_cross(
        ...
        root='/zw/data/mask/cart/cart_20.mat')
        # root = '/zw/data/mask/cart/cart_20.mat')
    ...
    for i_batch, sample_batched in enumerate(dataloader):
        ...
        # mask_20 = loadmat('/zw/data/mask/radial/r5.mat')['mask']
        # mask_40 = loadmat('/zw/data/mask/radial/40.mat')['mask']
        # mask_60 = loadmat('/zw/data/mask/60_2.mat')['mask']
        # mask_79 = loadmat('/zw/data/mask/80_2.mat')['mask']
        mask_20 = loadmat('/zw/data/mask/cart/cart_20.mat')['mask']
        mask_40 = loadmat('/zw/data/mask/cart_real/40.mat')['mask']
        mask_60 = loadmat('/hy/DuDoRNet-master/DuDoRNet-master/Data/mask/cart/cart_60.mat')['mask']
        mask_79 = loadmat('/hy/DuDoRNet-master/DuDoRNet-master/Data/mask/cart/cart_80.mat')['mask']
        # mask_10 = loadmat('/zw/data/mask/random/random2D_10.mat')['mask']
        # mask_20 = loadmat('/zw/mask_random/random2D_20.mat')['mask']
        # mask_40 = loadmat('/zw/mask_random/random2D_40.mat')['mask']
        # mask_60 = loadmat('/zw/mask_random/random2D_60.mat')['mask']
        # mask_79 = loadmat('/zw/mask_random/random2D_80.mat')['mask']
        ...
        # # # # # # # # #
        # # with torch.no_grad():
        # #     reconstruct_4_real_imag = net_79(input_w_next)
        # #
        # # reconstruct_79, input_w_next,input_nw_next = get_next_net(input_t,
        # #                                                      reconstruct_4_real_imag,
        # #                                                      weight, mask_10, mask_100)
        # # input_w_next = torch.Tensor(input_w_next).unsqueeze(0).to(device)
        # # input_nw_next = torch.Tensor(input_nw_next).unsqueeze(0).to(device)
        # # reconstruct = reconstruct_79
        # # # # #
        # # # # # input_w_next[:, 0, :, :] = input_w_next[:, 2, :, :]
        # # # # # input_w_next[:, 1, :, :] = input_w_next[:, 3, :, :]
        # # # #
