...
def main(args):
    ...
    mri_dataset = mriDataset_real_imag_cross(
        ...
        # root="/zw/data/mask/radial/10.mat")
        # root1='/zw/data/zh/T1_test',
        # root2='/zw/data/zh/T2_test',
        # root='/zw/data/mask/cart_2/20.mat')
    ...
    for i_batch, sample_batched in enumerate(dataloader):
        ...
        # w_path =  '/zw/data/weight/weight_0.5_1e2.mat'
        w_path = '/zw_2/M4Raw/data/weight/weight_T1_0.5_1e2.mat'
        # m_path = '/zw/ACNN/result_mask_2/'
        ...
        # new psnr and ssim
        ori_complex_sos2 = ori_complex_sos
        pred_2_complex_sos2 = pred_2_complex_sos
        input_2coil_complex_img_sos2 = input_2coil_complex_img_sos
        ...
        # new psnr and ssim
        psnr_compress_zero2 = compare_psnr(255 * abs(ori_complex_sos2), 255 * abs(input_2coil_complex_img_sos2),
                                          data_range=255)
        ssim_compress_zero2 = compare_ssim(abs(ori_complex_sos2), abs(input_2coil_complex_img_sos2))
        psnr_compress2 = compare_psnr(255 * abs(ori_complex_sos2), 255 * abs(pred_2_complex_sos2), data_range=255)
        ssim_compress2 = compare_ssim(abs(ori_complex_sos2), abs(pred_2_complex_sos2))
        ...
        PSNR_COMPRESS2.append(psnr_compress2)
        SSIM_COMPRESS2.append(ssim_compress2)
        PSNR_zero2.append(psnr_compress_zero2)
        SSIM_zero2.append(ssim_compress_zero2)
    ...
    # new psnr and ssim
    ave_psnr_compress2 = sum(PSNR_COMPRESS2) / len(PSNR_COMPRESS2)
    ave_ssim_compress2 = sum(SSIM_COMPRESS2) / len(SSIM_COMPRESS2)
    ave_psnr_zero2 = sum(PSNR_zero2) / len(PSNR_zero2)
    ave_ssim_zero2 = sum(SSIM_zero2) / len(SSIM_zero2)
    print("new:")
    print("ave_psnr_forward: %.10f || ave_ssim_forward:%.10f" % (ave_psnr_compress2, ave_ssim_compress2))
    print("ave_psnr_zero: %.10f || ave_ssim_zero:%.10f" % (ave_psnr_zero2, ave_ssim_zero2))
